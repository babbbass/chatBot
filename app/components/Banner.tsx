...
export function Banner() {
  return (
    <div className='w-4/5 px-5 my-10'>
      <div className='flex justify-between items-center mb-5 w-full'>
        <h1 className='text-3xl font-semibold bg-gradient-to-r from-white to-gold text-transparent bg-clip-text '>
          PSG-BOYZ Chat
        </h1>
        <Image src={psgBoyLogo} width={75} alt='psgBoyLogo' />
      </div>
      <p className='p-0 px-14 text-lg text-slate-50 font-semibold'>
